...
| This settings work with auth class that provides a lightweight and simple 
| auth implementation for user authentication management.
|
*/
...
$auth['is_not_ok_url']       = '/login';    // $this->auth->is_not_ok() function redirect url.
$auth['is_ok_url']           = '/dashboard';// $this->auth->is_ok() function redirect url.
